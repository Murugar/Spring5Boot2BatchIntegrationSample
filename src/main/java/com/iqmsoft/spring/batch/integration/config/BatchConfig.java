package com.iqmsoft.spring.batch.integration.config;
...
import com.iqmsoft.spring.batch.integration.domain.Entry;
import com.iqmsoft.spring.batch.integration.domain.EntryFieldSetMapper;
import com.iqmsoft.spring.batch.integration.domain.EntryRepository;
...
public class BatchConfig {
	...
	public FlatFileItemReader<Entry> reader(
		...
		tokenizer.setNames(new String[] { "source", "destination", "amount", "date", "type" });
